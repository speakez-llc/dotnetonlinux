...
While this site will focus on working with .NET and software engineering related concerns, we expect that this will be a growing area of interest among a broad array of computer users in months and years to come. And as a final bit or irony, we'll all have Microsoft to "thank" for providing the final nudge to this technology era's latest "tipping point".
